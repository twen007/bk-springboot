    ...
    <body onLoad="initPage()">
        ...
        <div id="content">
            ...
            <div id="login-panel">
                ...
                <div id="panel">
                    <p id="message">
                        You are here because your <b>session timed out</b> OR you clicked the <b>[Logout]</b> Button.
                        To completely terminate your session, you must close <b>all</b> tabs / windows.
                    </p>
                    
                    <p id="message">
                       To login again, click the button below.
                    </p>
                    <form>
                        <button id="login-btn" formaction="app/index.html">Log in again</button>
                    </form>
                </div>
                <br/>
                <div id="contact">
