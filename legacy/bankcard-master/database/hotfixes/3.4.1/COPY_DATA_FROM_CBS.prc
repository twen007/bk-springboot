...
/******************************************************************************
   ...
   1.1        2/09/2024   Tony Wen       1. add code 14 of object classes becuase 14-15 is for convenience check BANK-561
...
FROM CBSIFUSR.CBS_NIST_PROJ_TASK_MV);
   ...
   INSERT INTO object_class
     ...
     where object1_code in (14,22,23,24,25,26,31) ) order by object1_code;
