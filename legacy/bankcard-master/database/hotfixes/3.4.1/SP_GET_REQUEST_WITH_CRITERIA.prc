   ...
   --     ELSE
    ...
    OPEN result_set FOR SELECT
                        ...
                        WHERE
                                ...
                                -- changed to user_ou_org_id from div_org_id; can't make it always true if user select no division
                            AND div_org_id = nvl(query_div_org_id, user_div_org_id) 
