...
CREATE OR REPLACE PROCEDURE BCPMS_OWNER.sp_insert_route_n (
    ...
    2/2/23 remove the logic that checks for different OUs between the "route by ou" and "route to ou"
           since detailees from different ou can create and route requests
    **/
...
(REQUEST_ID, REQUESTER_NAME, REQUESTER_ID, ROUTE_ID, ROUTE_TYPE_ID, 
 ROUTE_TYPE_NAME, ROUTE_NOTES, ROUTE_BY_NAME, ROUTE_BY, ROUTE_DATE, 
 ROUTE_STATUS_ID, ROUTE_STATUS_NAME, ROUTE_TO_NAME, ROUTE_TO)
BEQUEATH DEFINER
AS 
SELECT a.REQUEST_ID,
         ...
         d.ROUTE_TYPE_NAME,
         a.ROUTE_NOTES,
         nvl2(route_by_delegate, get_user_name (a.ROUTE_BY_DELEGATE) || ' [on behalf of '|| get_user_name (a.ROUTE_BY) || ']', get_user_name (a.ROUTE_BY))   AS route_by_name,
         a.ROUTE_BY,
         a.ROUTE_DATE,
         a.ROUTE_STATUS_ID,
         c.ROUTE_STATUS_NAME,
