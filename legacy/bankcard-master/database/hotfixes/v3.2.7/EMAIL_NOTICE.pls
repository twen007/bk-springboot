...
DECLARE
    ...
    */
    ...
    l_app_instruction        VARCHAR2 (1000) :='<br>After the request is reviewed, please go to the [Routes] tab to approve or reject it.';
    l_description            VARCHAR2 (2000) := '';
    l_total_cost             NUMBER (10, 2);
    l_needed_by_date         DATE;
    l_notes                  VARCHAR2 (2000) := '';
    l_body_notify            VARCHAR2 (2000) := '';
