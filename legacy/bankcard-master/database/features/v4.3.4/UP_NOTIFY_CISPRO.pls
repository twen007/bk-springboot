--change l_body from nvarchar to clob to prevent email error when the body of the message is too long
create or replace PROCEDURE             UP_NOTIFY_CISPRO (
    p_request_id    INT,
...
BEGIN
    ...
    */
    ...
    up_send_email_clob (l_sender_email,
                   l_receip_email,
                   l_cc_email,
                   l_app_bcc,
                   l_subject,
