create or replace PROCEDURE             sp_insert_route_n (
    /**
    ...
    **/
    ...
    p_omit_notification     IN     INTEGER,
...
BEGIN
    ...
    --01/2025: This logic was added to the SP_INSERT_ROUTE 08/2024 but not in this SP. 
    --This should fixed the issue users reported recently on not able to reapprove a request that needs ITSO approval
    IF p_route_status_id = 11 OR p_route_status_id = 14 OR p_route_status_id = 15
    THEN
