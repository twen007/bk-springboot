  CREATE OR REPLACE FORCE EDITIONABLE VIEW "BCPMS_OWNER"."V_RPT_PROPERTY_CUSTODIAN_ITEMS" ("REQUEST_ID", "FY", "CREATED_DATE", "REQUISITION_NUMBER", "OU_ID", "DIV_ID", "GRP_ID", "OU", "DIVISION", "Group", "Vendor", "ITEM_ID", "CATELOG_NUMBER", "ITEM_NAME", "ITEM_DESCRIPTION", "PRICE", "QUANTITY", "PURPOSE", "IS_CHEMICAL", "SHOPPING_CART_FILE_ID", "ITEM_STATUS", "ITEM_STATUS_ID", "PROJECT_TASK", "OBJECT_CLASS", "IS_TAGGABLE_EQUIPMENT", "PRICE_ORDERED", "QUANTITY_ORDERED", "ITEM_NOTES", "DATE_RECEIVED", "TRANSACTION_NUMBER", "STATEMENT_DATE", "UNIT_ISSUE","PURCHASE_TYPE_ID") AS 
  SELECT r.REQUEST_ID,
       r.fy,
       r.created_date,
       ...
       lis.item_status_type_id     AS Item_status_id,
       i.PROJECT_TASK,
       i.OBJECT_CLASS,
       ...
       i.STATEMENT_DATE,
       i.UNIT_ISSUE,
       r.purchase_type_id AS purchase_type_id
  FROM item                   i,
       request                r,
