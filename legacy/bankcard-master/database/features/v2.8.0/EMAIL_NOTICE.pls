...
DECLARE
    ...
    */
    ...
    l_foot                 NVARCHAR2(250) := '<br><br>This message is auto generated by the OU Bankcard Request and Approval system. Please do not reply to this email.';
...
BEGIN
    ...
    END IF;
    IF l_needed_by_date IS NOT NULL THEN
        l_body_extra := l_body_extra
    ...
    IF :new.route_notes IS NOT NULL THEN
        l_body_extra := l_body_extra
...
--        ELSIF l_route_type_id <> 7 THEN -- 7 is received. 
    ...
    IF
        l_route_type_id = 1
        AND l_also_notify IS NOT NULL
    THEN
        up_send_email(l_sender_email, l_also_notify, l_cc_email, l_app_bcc, l_subject
                --|| :new.request_id
                                                                            || ' has been '
                                                                            || l_route_type_name,
                     l_body_notify
    ...
    IF
        l_send_req_to_bch
        AND l_sender_email <> l_receip_email
    THEN
