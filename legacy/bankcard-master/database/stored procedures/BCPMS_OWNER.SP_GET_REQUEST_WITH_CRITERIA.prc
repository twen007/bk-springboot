...
CREATE OR REPLACE SYNONYM BCPMS_APP.SP_GET_REQUEST_WITH_CRITERIA FOR BCPMS_OWNER.SP_GET_REQUEST_WITH_CRITERIA;


AUDIT RENAME ON BCPMS_OWNER.SP_GET_REQUEST_WITH_CRITERIA BY ACCESS WHENEVER SUCCESSFUL;
AUDIT RENAME ON BCPMS_OWNER.SP_GET_REQUEST_WITH_CRITERIA BY ACCESS WHENEVER NOT SUCCESSFUL;

GRANT EXECUTE ON BCPMS_OWNER.SP_GET_REQUEST_WITH_CRITERIA TO BCPMS_APP;