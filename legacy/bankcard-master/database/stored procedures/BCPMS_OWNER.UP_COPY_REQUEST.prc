/* Formatted on 8/9/2019 3:13:41 PM (QP5 v5.313) */
...
BEGIN
    ...
    --insert into request_vendor
    INSERT INTO request_vendor (request_id,
                                vendor_id,
                                convenience_check,
...
CREATE OR REPLACE SYNONYM BCPMS_APP.UP_COPY_REQUEST FOR BCPMS_OWNER.UP_COPY_REQUEST;


AUDIT RENAME ON BCPMS_OWNER.UP_COPY_REQUEST BY ACCESS WHENEVER SUCCESSFUL;
AUDIT RENAME ON BCPMS_OWNER.UP_COPY_REQUEST BY ACCESS WHENEVER NOT SUCCESSFUL;

GRANT EXECUTE ON BCPMS_OWNER.UP_COPY_REQUEST TO BCPMS_APP;